...
zmax  = Matrix{Int64}(nbInstances , nbDivisionRun); zmax[:] = typemin(Int64)  # -Inf entier
zmoy  = zeros(Float64, nbInstances, nbDivisionRun) # zero
zmin  = Matrix{Int64}(nbInstances , nbDivisionRun) ; zmin[:] = typemax(Int64)  # +Inf entier
...
for instance = 1:nbInstances
    ...
    for runGrasp = 1:nbRunGrasp
        ...
        tutilise = toq() # arrete et releve le compteur de temps
        cpt+=1; print(cpt%10)
